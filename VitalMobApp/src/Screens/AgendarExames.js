...
export default function AgendarExames({ navigation, route }) {
    ...
    const data = [
        { key: '1', value: 'Hemograma Completo' },
        { key: '2', value: 'Eletrocardiograma' },
        { key: '3', value: 'Ecocardiograma' },
        { key: '4', value: 'Densitometria Óssea' },
        { key: '5', value: 'Ultrassom Abdomen Total' },
        { key: '6', value: 'Eletroencefalograma' },
        { key: '7', value: 'Ressonância Magnética Crânio' },
        { key: '8', value: 'Endoscopia Digestiva' }
    ];
    const exames = [
        {
      ...
      async function createExam() {
        const selectedExam = exames.filter((item) => item['nome'] == exame)[0];
        if (existingExams.includes(selectedExam['nome'])) {
          try {
            ...
            await addDoc(userExamsRef, {
              ...
              data: dia,
              hora: hora,
              preco: selectedExam.preco,
              orientaTitulo: selectedExam.orientaTitulo,
              orientaDetalhes: selectedExam.orientaDetalhes,
              imagem: selectedExam.imagem,
            });
            console.log('Exame marcado');
    ...
    return (
        <View style={styles.container}>
            ...
            <Pressable style={styles.botaoAgendar} onPress={createExam}>
...
{/* <View style={styles.container}>
            <Text style={{ fontWeight: 'bold', fontSize: 30, paddingTop: 30 }}>Agendar Exames</Text>
            <View style={styles.selecaoExame}>
                <Pressable onPress={() => navigation.navigate('exames')}>
                    <View>
                        <Text style={{ color: 'black' }}>Hemograma Completo</Text>
                    </View>

                </Pressable>
                <Pressable style={styles.botaoAgendar}>
                    <Text style={{ fontWeight: 'bold', color: '#ffffff' }}>AGENDAR</Text>
                </Pressable>
            </View>

            <View style={styles.formularioExame}>
                <View style={styles.inputContainer}>
                    <View style={styles.inputTitulo}>
                        <Text>Data de Exame</Text>
                    </View>
                </View>
            </View>
